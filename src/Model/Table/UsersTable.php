 ...
 * @property \App\Model\Table\PasswordResetsTable&\Cake\ORM\Association\HasMany $PasswordResets
...
class UsersTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->hasMany('PasswordResets', [
            'foreignKey' => 'user_id',
        ]);
        $this->hasMany('Posts', [
            'foreignKey' => 'user_id',
        ]);
        $this->hasMany('ReceivedNotifications', [
            'className' => 'Notifications',
            'foreignKey' => 'recipient_user_id',
        ]);
        $this->hasMany('SentNotifications', [
            'className' => 'Notifications',
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->regex('username', '/^[a-z0-9_]+$/', 'Username must contain only lowercase letters, numbers, and underscores')
